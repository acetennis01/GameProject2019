...
//class for level 3
public class Level5 extends JPanel implements MouseMotionListener, MouseListener, ActionListener
{
    ...
    public Level5()
    {
        ...
        birdTimer = new Timer(7, birdMover);
        birdTimer.start();
        ...
        levelLabel = new JLabel("Level: 5", JLabel.CENTER);
    ...
    class Rock
    {
        ...
        public void move()
        {
            ...
            if((rockX+15)>=550&&(rockX+50<=875&&(rockY-15>=343&&rockY<743)))
            {
                System.out.println("hit");
                hitTree = true;
                rockTimer1.stop();
    ...
    public void paintComponent(Graphics g)
    {
        ...
        if(!hitTree)
            g.drawImage(tree,550,343,325,400,null);
        else
        {
        ...
        if(hit) {
            ...
            new Thread(new Runnable() {
                ...
                public void run()
                {
                    ...
                    //Main.card.show(Main.panel,"Level 2");
                }
            }).start();
