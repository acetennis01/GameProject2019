...
//class for Level 2
public class Level2 extends JPanel implements MouseMotionListener, MouseListener, ActionListener
{
    ...
    public boolean shot, hit, hitTree;
    public Image bird, slingshot, homePic, homePicOG, background, tree;
    ...
    public Level2()
    {
        ...
        levelLabel = new JLabel("Level: 2", JLabel.CENTER);
    ...
    class Rock
    {
        ...
        public void move()
        {
            ...
            if((rockX+15)>=1280&&(rockX+15<=1440)&&(rockY-15>=328&&rockY<420))
            {
                hit=true;
                rockTimer1.stop();
                rockManager.removeFirst();
            ...
            //550,243,325,400
            if((rockX+15)>=550&&(rockX+50<=875&&(rockY-15>=243&&rockY<643)))
            {
    ...
    public void paintComponent(Graphics g)
    {
        ...
        if(!hitTree)
            g.drawImage(tree,550,243,325,400,null);
        else
        {
            Font font = new Font("Serif", Font.BOLD, 100);
            g.setFont(font);
            g.drawString("You hit the tree", 333, 509);
        ...
        if(hit) {
            ...
            new Thread(new Runnable() {
                ...
                public void run()
                {
                    ...
                    Main.card.show(Main.panel,"Level 3");
