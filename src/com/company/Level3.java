...
//class for level 3
public class Level3 extends JPanel implements MouseMotionListener, MouseListener, ActionListener
{
    ...
    public Level3()
    {
        ...
        birdTimer = new Timer(6, birdMover);
        birdTimer.start();
        ...
        levelLabel = new JLabel("Level: 3", JLabel.CENTER);
        ...
        if(hit) {
            ...
            new Thread(new Runnable() {
                ...
                public void run()
                {
                    ...
                    Main.card.show(Main.panel,"Level 4");
